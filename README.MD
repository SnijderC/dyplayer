...
arguments. If you do not intend to play songs by file name, you can skip the 
...
Assiging chunks of memory and then freeing them leaves holes in the memory that
